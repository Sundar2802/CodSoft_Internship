...
class User_account {
    ...
    protected User_account() {
        ...
        User2136010075.put("Name", "Sundar S");
        User2136010075.put("AccountNo", "9944798651");
        User2136010075.put("Balance", "25000");
        User2136010075.put("Password", "Sundar@28");

        Map<String, String> User2136010014 = new LinkedHashMap<>();
        User2136010014.put("Name", "Ram Prasath");
        User2136010014.put("AccountNo", "1234567890");
        User2136010014.put("Balance", "20000");
        User2136010014.put("Password", "ram7001");

        Userdata.put("9944798651", User2136010075);
        Userdata.put("1234567890", User2136010014);
    }
...
public class ATM_System extends User_account {
    ...
    protected static void perform_operations() {
        ...
        while (run) {
            ...
            switch (opt) {
                ...
                case 4:
                    run = false;
                    System.out.println("Thank you for using MONEYMATTER ATM. Goodbye!");
                    break;
                default:
    ...
    public static void main(String[] args) {
        System.out.print("Welcome to MONEYMATTER ATM\nEnter Your Account No: ");
        accno = scanner.next();
